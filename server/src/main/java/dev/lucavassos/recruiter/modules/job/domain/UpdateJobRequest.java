...
public class UpdateJobRequest extends NewJobRequest {
    ...
    UpdateJobRequest(Long id, String client, String name, JobStatus status, ContractTypeName contractType, Integer wantedCvs, Integer experienceRangeMin, Integer experienceRangeMax, Integer noticePeriodInDays, List<RawSkillDto> rawSkills, Double salaryBudget, Currency currency, String description, Double bonusPayPerCv, String closureBonus, String comments) {
        super(client, name, status, contractType, wantedCvs, experienceRangeMin, experienceRangeMax, noticePeriodInDays, rawSkills, salaryBudget, currency, description, bonusPayPerCv, closureBonus, comments);
        this.id = id;
    }
}
