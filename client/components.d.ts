...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    ClientDropdown: typeof import('./src/components/job/shared/ClientDropdown.vue')['default']
    ...
    copy: typeof import('./src/components/job/jobs-table/DashboardJobCard copy.vue')['default']
