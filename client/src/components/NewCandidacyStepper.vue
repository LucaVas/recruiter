  ...
  <Stepper v-model:activeStep="active" class="flex h-full w-[50rem] flex-col justify-start">
      ...
      <template #content="{ prevCallback, nextCallback }">
        <div class="flex h-full w-full flex-col justify-between gap-6">
          <div class="flex flex-col gap-4">
            <div class="mb-3 mt-3 text-center text-xl font-semibold">Add Candidacy Details</div>

            <!-- relevant experience + expected CTC -->
            ...
            <div class="field p-fluid flex w-full">
              <Textarea
                ...
                style="resize: none"
                :disabled="candidacyDetails.actualNoticePeriod === ''"
              />
            </div>
          </div>
    ...
    <StepperPanel>
      ...
      <template #content="{ prevCallback, nextCallback }">
        <div class="flex h-full w-full flex-col justify-between gap-6">
          <div class="flex flex-col gap-4">
            <div class="mb-3 mt-3 text-center text-xl font-semibold">Final remarks</div>
    ...
    <StepperPanel>
      ...
      <template #content="{ prevCallback }">
        ...
        >
          ...
          <Message v-if="newCandidacyError" severity="error" :closable="false" class="w-full">{{
            newCandidacyError
          }}</Message>
          <div class="flex justify-between pt-4">
            <Button
        ...
        <div v-else class="mb-auto flex h-full w-full flex-col justify-between gap-6">
          <div class="flex flex-col gap-4">
            <div class="mx-auto mb-5 flex flex-col gap-4">
              <div class="mb-3 mt-3 text-center text-xl font-semibold">
              ...
              <div class="text-center">
                ...
                >
                  <path
                    id="b9ccae5a-ffdd-4f5c-9c1e-05af9f0f3372-138"
                    data-name="Path 438"
                  ...
                  />
                  <path
                    id="f4ad1d06-bd03-4ced-a5c4-c19a65ab4ee5-139"
                    data-name="Path 439"
                  ...
                  />
                  <path
                    id="baf785f8-b4c6-42cf-85bd-8a16037845f7-140"
                    data-name="Path 442"
                  ...
                  />
                  <path
                    id="a14e4330-7125-4e03-a856-d6453c34f6cc-141"
                    data-name="Path 443"
                  ...
                  />
                  <path
                    id="ac20a106-7eb8-4a45-8835-674ef3bf3222-142"
                    data-name="Path 141"
                  ...
                  />
                  <path
                    id="a8878079-c7cd-406f-a434-8b15b914b9b4-143"
                    data-name="Path 141"
                  ...
                  />
                  <path
                    id="af64f961-e9a2-4c53-a333-5060c7f850d2-144"
                    data-name="Path 142"
                  ...
                  />
                  <path
                    id="baad4cfb-158d-4439-9cc3-22475bf47b22-145"
                    data-name="Path 143"
                  ...
                  />
                  <path
                    id="f3456279-91e5-49ad-aa43-9838b26fb6ca-146"
                    data-name="Path 142"
                  ...
                  />
                  <path
                    id="a3288adf-49f8-485f-8ae9-1e4f1a13d849-147"
                    data-name="Path 143"
                  ...
                  />
                  <path
                    id="e63a5b48-5a7d-40a2-b9b0-6adec326348a-148"
                    data-name="Path 142"
                  ...
                  />
                  <path
                    id="a1c669b4-dfc3-4cfa-a7be-66b71399844d-149"
                    data-name="Path 143"
                  ...
                  />
                  <path
                    id="bfec50d1-ffb1-4de6-a9ef-a1085e40e016-150"
                    data-name="Path 142"
                  ...
                  />
                  <path
                    id="bc9696ec-ec99-41d5-9116-3ad9737a38ac-151"
                    data-name="Path 143"
